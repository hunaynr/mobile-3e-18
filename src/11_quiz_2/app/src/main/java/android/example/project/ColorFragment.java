 ...
 */
public class ColorFragment extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button changeFragmentBack = findViewById(R.id.btnChangeBack);
        changeFragmentBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ColorFragment.this, ResultActivity.class));
            }
        });
    }
